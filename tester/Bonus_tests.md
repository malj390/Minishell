# Minishell Bonus Test Suite Report
...
**Legend:** Status ❌ indicates a mismatch in output or exit code.

## 00_echo (PASS)
- Bash Exit: `0` | Minishell Exit: `0`

| Status | Command | Bash Output | Minishell Output |
| :---: | :--- | :--- | :--- |
| ✅ | `echo hello               ` | `hello                    ` | `hello                    ` |
| ✅ | `echo -n noeol            ` | `noeol                    ` | `noeol                    ` |
| ✅ | `echo -n                  ` | `                         ` | `                         ` |
...
| ✅ | `echo ""uhjkhnkj"hjbmb"'''`<br>`' defdjhfkjb "iujiouhj"f'`<br>`f'a'j'o''i'w'q''q        ` | `uhjkhnkjhjbmb defdjhfkjb `<br>`iujiouhjffajoiwqq        ` | `uhjkhnkjhjbmb defdjhfkjb `<br>`iujiouhjffajoiwqq        ` |
| ✅ | `echo ""aaaaaaaa"bbbbb"'''`<br>`' ccccccccc "dddddddd"e'e`<br>`'e                       ` | `aaaaaaaabbbbb ccccccccc d`<br>`dddddddeee               ` | `aaaaaaaabbbbb ccccccccc d`<br>`dddddddeee               ` |
| ✅ | `echo "ho   $USER"  'la   `<br>`$LESS'   $USER$TERM      ` | `ho   42user la   $LESS 42`<br>`userxterm                ` | `ho   42user la   $LESS 42`<br>`userxterm                ` |
| ✅ | `echo "ho   $USER"'la   $L`<br>`ESS'$USER$TERM           ` | `ho   42userla   $LESS42us`<br>`erxterm                  ` | `ho   42userla   $LESS42us`<br>`erxterm                  ` |
| ✅ | `echo"ho   $USER"         ` | `shell: echoho   42user: c`<br>`ommand not found         ` | `shell: echoho   42user: c`<br>`ommand not found         ` |
| ✅ | `echo"ho   $USE$LESS"     ` | `shell: echoho   : command`<br>` not found               ` | `shell: echoho   : command`<br>` not found               ` |
| ✅ | `"echo ho   $USER"        ` | `shell: echo ho   42user: `<br>`command not found        ` | `shell: echo ho   42user: `<br>`command not found        ` |
| ✅ | `"echo" "ho   $USER"      ` | `ho   42user              ` | `ho   42user              ` |
| ✅ | `e"cho" "ho   $USER"      ` | `ho   42user              ` | `ho   42user              ` |
| ✅ | `       echo "ho   $USER" ` | `ho   42user              ` | `ho   42user              ` |
| ✅ | `echo "$HOME '$LESS' $USER`<br>`"                        ` | `/home/42user '' 42user   ` | `/home/42user '' 42user   ` |
| ✅ | `echo '$HOME "$LESS" $USER`<br>`'                        ` | `$HOME "$LESS" $USER      ` | `$HOME "$LESS" $USER      ` |
| ✅ | `echo "$HOME '$LESS "pa $T`<br>`ERM" na' $USER"          ` | `/home/42user ' pa xterm n`<br>`a' 42user                ` | `/home/42user ' pa xterm n`<br>`a' 42user                ` |
| ✅ | `echo '$HOME "$LESS 'pa $T`<br>`ERM' na" $USER'          ` | `$HOME "$LESS pa xterm na"`<br>` $USER                   ` | `$HOME "$LESS pa xterm na"`<br>` $USER                   ` |
| ✅ | `echo '$'"HOME"           ` | `$HOME                    ` | `$HOME                    ` |
...
| ✅ | `cd                       ` | `shell: cd: HOME not set  ` | `shell: cd: HOME not set  ` |
| ✅ | `echo $?                  ` | `0                        ` | `0                        ` |
| ✅ | `directorio existe        ` | `shell: directorio: comman`<br>`d not found              ` | `shell: directorio: comman`<br>`d not found              ` |
| ✅ | `directorio no existe     ` | `shell: directorio: comman`<br>`d not found              ` | `shell: directorio: comman`<br>`d not found              ` |
| ✅ | `file existe              ` | `existe: cannot open `exis`<br>`te' (No such file or dire`<br>`ctory)                   ` | `existe: cannot open `exis`<br>`te' (No such file or dire`<br>`ctory)                   ` |
| ✅ | `cd                       ` | `shell: cd: HOME not set  ` | `shell: cd: HOME not set  ` |
| ✅ | `           cd            ` | `shell: cd: HOME not set  ` | `shell: cd: HOME not set  ` |
| ✅ | `cd - = $OLDPWD           ` | `shell: cd: too many argum`<br>`ents                     ` | `shell: cd: too many argum`<br>`ents                     ` |
| ✅ | `cd ~ = $HOME             ` | `shell: cd: too many argum`<br>`ents                     ` | `shell: cd: too many argum`<br>`ents                     ` |
| ✅ | `cd $HOME si $HOME no exis`<br>`te                       ` | `shell: cd: too many argum`<br>`ents                     ` | `shell: cd: too many argum`<br>`ents                     ` |
| ✅ | `cd directorio con distint`<br>`os permisos              ` | `shell: cd: too many argum`<br>`ents                     ` | `shell: cd: too many argum`<br>`ents                     ` |

## 02_export_unset_env (PASS)
- Bash Exit: `0` | Minishell Exit: `0`
...
| ✅ | `export C=3               ` | `                         ` | `                         ` |
| ✅ | `unset B                  ` | `                         ` | `                         ` |
| ✅ | `env \| grep -E "^A=\|^B=\`<br>`|^C=" \| sort            ` | `A=1                      `<br>`C=3                      ` | `A=1                      `<br>`C=3                      ` |
| ✅ | `export $USER=la          ` | `shell: export: `42user=la`<br>`': not a valid identifier` | `shell: export: `42user=la`<br>`': not a valid identifier` |
| ✅ | `echo $USER               ` | `42user                   ` | `42user                   ` |
| ✅ | `export a b=$LESS c=d     ` | `                         ` | `                         ` |
| ✅ | `echo $a $b $c            ` | `d                        ` | `d                        ` |
| ✅ | `export ""                ` | `shell: export: `': not a `<br>`valid identifier         ` | `shell: export: `': not a `<br>`valid identifier         ` |
| ✅ | `echo "before whitespace o`<br>`nly line"                ` | `before whitespace only li`<br>`ne                       ` | `before whitespace only li`<br>`ne                       ` |
| ✅ | `echo "after"             ` | `after                    ` | `after                    ` |
| ✅ | `echo "testing dollar in v`<br>`arious positions"        ` | `testing dollar in various`<br>` positions               ` | `testing dollar in various`<br>` positions               ` |
| ✅ | `export EDGE_VAR=42       ` | `                         ` | `                         ` |
| ✅ | `echo "value=$EDGE_VAR"   ` | `value=42                 ` | `value=42                 ` |
| ✅ | `echo $EDGE_VAR$EDGE_VAR  ` | `4242                     ` | `4242                     ` |
| ✅ | `echo "$EDGE_VAR""$EDGE_VA`<br>`R"                       ` | `4242                     ` | `4242                     ` |
| ✅ | `env \| grep _=           ` | `_=/usr/bin/env           ` | `_=/usr/bin/env           ` |
| ✅ | `unset _                  ` | `                         ` | `                         ` |
| ✅ | `env \| grep _=           ` | `_=/usr/bin/env           ` | `_=/usr/bin/env           ` |
...
| Status | Command | Bash Output | Minishell Output |
| :---: | :--- | :--- | :--- |
| ✅ | `ls                       ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    ` |
| ✅ | `/bin/ls -la /dev/null    ` | `crw-rw-rw- 1 root root 1,`<br>` 3 Apr 25 17:02 /dev/null` | `crw-rw-rw- 1 root root 1,`<br>` 3 Apr 25 17:02 /dev/null` |
| ✅ | `ls \| grep ".c"          ` | `interactive              `<br>`minishell.cast           `<br>`non_interactive          ` | `interactive              `<br>`minishell.cast           `<br>`non_interactive          ` |
| ✅ | `/bin/echo hello world    ` | `hello world              ` | `hello world              ` |
| ✅ | `/bin/echo -n noeol       ` | `noeol                    ` | `noeol                    ` |
| ✅ | `/bin/echo                ` | `                         ` | `                         ` |
| ✅ | `/bin/echo hello          ` | `hello                    ` | `hello                    ` |
| ✅ | `/bin/ls /dev/null        ` | `/dev/null                ` | `/dev/null                ` |
| ✅ | `/usr/bin/true            ` | `                         ` | `                         ` |
| ✅ | `/usr/bin/false           ` | `                         ` | `                         ` |
| ✅ | `/bin/echo done           ` | `done                     ` | `done                     ` |
| ✅ | `echo $?                  ` | `0                        ` | `0                        ` |
| ✅ | `ls noexiste              ` | `ls: cannot access 'noexis`<br>`te': No such file or dire`<br>`ctory                    ` | `ls: cannot access 'noexis`<br>`te': No such file or dire`<br>`ctory                    ` |
| ✅ | `unset PATH               ` | `                         ` | `                         ` |
| ✅ | `ls                       ` | `shell: ls: No such file o`<br>`r directory              ` | `shell: ls: No such file o`<br>`r directory              ` |
...
| ✅ | `echo hello \| cat \| cat ` | `hello                    ` | `hello                    ` |
| ✅ | `echo hello \| wc -c      ` | `6                        ` | `6                        ` |
| ✅ | `printf "b\na\nc\n" \| sor`<br>`t                        ` | `a                        `<br>`b                        `<br>`c                        ` | `a                        `<br>`b                        `<br>`c                        ` |
| ✅ | `/bin/ls /dev/null \| cat ` | `/dev/null                ` | `/dev/null                ` |
| ✅ | `echo "apple banana cherry`<br>`" \| tr ' ' '\n' \| sort ` | `apple                    `<br>`banana                   `<br>`cherry                   ` | `apple                    `<br>`banana                   `<br>`cherry                   ` |
| ✅ | `echo "abc" \| rev \| rev ` | `abc                      ` | `abc                      ` |
| ✅ | `echo "line1" > /tmp/ms_co`<br>`mplex_a.txt              ` | `                         ` | `                         ` |
| ✅ | `echo "line2" >> /tmp/ms_c`<br>`omplex_a.txt             ` | `                         ` | `                         ` |
| ✅ | `echo "line3" >> /tmp/ms_c`<br>`omplex_a.txt             ` | `                         ` | `                         ` |
| ✅ | `cat /tmp/ms_complex_a.txt`<br>` \| wc -l                ` | `3                        ` | `3                        ` |
| ✅ | `cat /tmp/ms_complex_a.txt`<br>` \| grep "line" \| wc -l ` | `3                        ` | `3                        ` |
| ✅ | `cat /tmp/ms_complex_a.txt`<br>` \| sort -r > /tmp/ms_com`<br>`plex_b.txt               ` | `                         ` | `                         ` |
| ✅ | `cat /tmp/ms_complex_b.txt` | `line3                    `<br>`line2                    `<br>`line1                    ` | `line3                    `<br>`line2                    `<br>`line1                    ` |
| ✅ | `ls /tmp/ms_complex_a.txt `<br>`\| wc -l                 ` | `1                        ` | `1                        ` |
| ✅ | `rm /tmp/ms_complex_a.txt `<br>`/tmp/ms_complex_b.txt    ` | `                         ` | `                         ` |
| ✅ | `ls \| wc                 ` | `      9       9     108  ` | `      9       9     108  ` |
| ✅ | `ls\|wc                   ` | `      9       9     108  ` | `      9       9     108  ` |
| ✅ | `sort colors.txt \| uniq \`<br>`| sort -r \| wc          ` | `sort: cannot read: colors`<br>`.txt: No such file or dir`<br>`ectory                   `<br>`      0       0       0  ` | `sort: cannot read: colors`<br>`.txt: No such file or dir`<br>`ectory                   `<br>`      0       0       0  ` |
| ✅ | `\|                       ` | `shell: syntax error near `<br>`unexpected token `\|'    `<br>`shell: `\|'              ` | `shell: syntax error near `<br>`unexpected token `\|'    `<br>`shell: `\|'              ` |
| ✅ | `"" \| ""                 ` | `                         ` | `                         ` |

## 05_quotes_and_expansion (PASS)
- Bash Exit: `0` | Minishell Exit: `0`
...
| ✅ | `echo "'$USER'"           ` | `'estudiante42'           ` | `'estudiante42'           ` |
| ✅ | `echo '"$USER"'           ` | `"$USER"                  ` | `"$USER"                  ` |
| ✅ | `echo "$COMPLICADO"       ` | `                         ` | `                         ` |
| ✅ | `echo '$COMPLICADO'       ` | `$COMPLICADO              ` | `$COMPLICADO              ` |
| ✅ | `echo "'$COMPLICADO'"     ` | `''                       ` | `''                       ` |
...
| ✅ | `cat /tmp/ms_test_redir.tx`<br>`t                        ` | `first line               ` | `first line               ` |
| ✅ | `echo "second line" >> /tm`<br>`p/ms_test_redir.txt      ` | `                         ` | `                         ` |
| ✅ | `cat /tmp/ms_test_redir.tx`<br>`t                        ` | `first line               `<br>`second line              ` | `first line               `<br>`second line              ` |
| ✅ | `echo "third line" >> /tmp`<br>`/ms_test_redir.txt       ` | `                         ` | `                         ` |
| ✅ | `wc -l < /tmp/ms_test_redi`<br>`r.txt                    ` | `3                        ` | `3                        ` |
| ✅ | `echo "overwrite" > /tmp/m`<br>`s_test_redir.txt         ` | `                         ` | `                         ` |
| ✅ | `cat /tmp/ms_test_redir.tx`<br>`t                        ` | `overwrite                ` | `overwrite                ` |
...
| Status | Command | Bash Output | Minishell Output |
| :---: | :--- | :--- | :--- |
| ✅ | `cat << EOF               `<br>`line one                 `<br>`line two                 `<br>`line three               `<br>`EOF                      ` | `line one                 `<br>`line two                 `<br>`line three               ` | `line one                 `<br>`line two                 `<br>`line three               ` |
| ✅ | `grep "an" << WORDS       `<br>`apple                    `<br>`banana                   `<br>`cherry                   `<br>`mango                    `<br>`WORDS                    ` | `banana                   `<br>`mango                    ` | `banana                   `<br>`mango                    ` |
| ✅ | `wc -l << COUNTER         `<br>`a                        `<br>`b                        `<br>`c                        `<br>`d                        `<br>`e                        `<br>`COUNTER                  ` | `5                        ` | `5                        ` |

## 08_bonus_wildcards (PASS)
- Bash Exit: `0` | Minishell Exit: `0`
...
| ✅ | `echo *                   ` | `bar.txt foo.c foo.h      ` | `bar.txt foo.c foo.h      ` |
| ✅ | `rm -rf /tmp/ms_wildcard_t`<br>`est                      ` | `                         ` | `                         ` |
| ✅ | `echo hola > out1         ` | `shell: out1: No such file`<br>` or directory            ` | `shell: out1: No such file`<br>` or directory            ` |
| ✅ | `cat out1                 ` | `cat: out1: No such file o`<br>`r directory              ` | `cat: out1: No such file o`<br>`r directory              ` |
| ✅ | `echo caracola >> out1    ` | `shell: out1: No such file`<br>` or directory            ` | `shell: out1: No such file`<br>` or directory            ` |
| ✅ | `cat out1                 ` | `cat: out1: No such file o`<br>`r directory              ` | `cat: out1: No such file o`<br>`r directory              ` |
| ✅ | `echo hola > out1 > out2 >`<br>` out3                    ` | `shell: out1: No such file`<br>` or directory            ` | `shell: out1: No such file`<br>` or directory            ` |
| ✅ | `ls out*                  ` | `ls: cannot access 'out*':`<br>` No such file or director`<br>`y                        ` | `ls: cannot access 'out*':`<br>` No such file or director`<br>`y                        ` |
| ✅ | `cat < colors.txt         ` | `shell: colors.txt: No suc`<br>`h file or directory      ` | `shell: colors.txt: No suc`<br>`h file or directory      ` |
| ✅ | `cat < colors.txt > copia.`<br>`txt                      ` | `shell: colors.txt: No suc`<br>`h file or directory      ` | `shell: colors.txt: No suc`<br>`h file or directory      ` |
| ✅ | `cat copia.txt            ` | `cat: copia.txt: No such f`<br>`ile or directory         ` | `cat: copia.txt: No such f`<br>`ile or directory         ` |
| ✅ | `cat colors.txt \| wc     ` | `cat: colors.txt: No such `<br>`file or directory        `<br>`      0       0       0  ` | `cat: colors.txt: No such `<br>`file or directory        `<br>`      0       0       0  ` |

## 09_bonus_logical_operators (PASS)
- Bash Exit: `0` | Minishell Exit: `0`

| Status | Command | Bash Output | Minishell Output |
| :---: | :--- | :--- | :--- |
| ✅ | `echo "extra" > /tmp/ms_co`<br>`mplex_a.txt && cat /tmp/m`<br>`s_complex_a.txt          ` | `extra                    ` | `extra                    ` |
| ✅ | `echo one && echo two     ` | `one                      `<br>`two                      ` | `one                      `<br>`two                      ` |
| ✅ | `(echo one && echo two)   ` | `one                      `<br>`two                      ` | `one                      `<br>`two                      ` |
| ✅ | `true && echo "true_passed`<br>`"                        ` | `true_passed              ` | `true_passed              ` |
| ✅ | `(true && echo "true_passe`<br>`d")                      ` | `true_passed              ` | `true_passed              ` |
| ✅ | `false && echo "SHOULD_NOT`<br>`_PRINT"                  ` | `                         ` | `                         ` |
| ✅ | `(false && echo "SHOULD_NO`<br>`T_PRINT")                ` | `                         ` | `                         ` |
| ✅ | `false \|\| echo "false_re`<br>`covered"                 ` | `false_recovered          ` | `false_recovered          ` |
| ✅ | `(false \|\| echo "false_r`<br>`ecovered")               ` | `false_recovered          ` | `false_recovered          ` |
| ✅ | `true \|\| echo "SHOULD_NO`<br>`T_PRINT"                 ` | `                         ` | `                         ` |
| ✅ | `(true \|\| echo "SHOULD_N`<br>`OT_PRINT")               ` | `                         ` | `                         ` |
| ✅ | `echo "start" && false \|\`<br>`| echo "fallback"        ` | `start                    `<br>`fallback                 ` | `start                    `<br>`fallback                 ` |
| ✅ | `(echo "start" && false) \`<br>`|\| echo "fallback"      ` | `start                    `<br>`fallback                 ` | `start                    `<br>`fallback                 ` |
| ✅ | `false \|\| false \|\| ech`<br>`o "last_resort"          ` | `last_resort              ` | `last_resort              ` |
| ✅ | `(false \|\| false \|\| ec`<br>`ho "last_resort")        ` | `last_resort              ` | `last_resort              ` |
| ✅ | `true && true && echo "all`<br>`_true"                   ` | `all_true                 ` | `all_true                 ` |
| ✅ | `(true && true && echo "al`<br>`l_true")                 ` | `all_true                 ` | `all_true                 ` |
| ✅ | `false \|\| true && echo "`<br>`chain_ok"                ` | `chain_ok                 ` | `chain_ok                 ` |
| ✅ | `(false \|\| true && echo `<br>`"chain_ok")              ` | `chain_ok                 ` | `chain_ok                 ` |
| ✅ | `(echo uno && (false \|\| `<br>`echo dos)) && echo tres  ` | `uno                      `<br>`dos                      `<br>`tres                     ` | `uno                      `<br>`dos                      `<br>`tres                     ` |
| ✅ | `(false && echo "nope") \|`<br>`\| (true && echo "ok")   ` | `ok                       ` | `ok                       ` |
| ✅ | `(echo "A" && (false \|\| `<br>`(echo "B" && true))) \|\|`<br>` echo "C"                ` | `A                        `<br>`B                        ` | `A                        `<br>`B                        ` |
| ✅ | `(false && (echo "no1" \|\`<br>`| echo "no2")) && echo "n`<br>`o3"                      ` | `                         ` | `                         ` |
| ✅ | `(true && (false \|\| (tru`<br>`e && echo "deep"))) && ec`<br>`ho "final"               ` | `deep                     `<br>`final                    ` | `deep                     `<br>`final                    ` |
| ✅ | `(false \|\| (echo "X" && `<br>`false) \|\| (echo "Y" && `<br>`true)) && echo "Z"       ` | `X                        `<br>`Y                        `<br>`Z                        ` | `X                        `<br>`Y                        `<br>`Z                        ` |
| ✅ | `(echo "start" && (false \`<br>`|\| (echo "mid" && false)`<br>`) && echo "never") \|\| e`<br>`cho "end"                ` | `start                    `<br>`mid                      `<br>`end                      ` | `start                    `<br>`mid                      `<br>`end                      ` |
| ✅ | `(false \|\| (false && ech`<br>`o "no") \|\| (true && ech`<br>`o "yes")) && echo "done" ` | `yes                      `<br>`done                     ` | `yes                      `<br>`done                     ` |
| ✅ | `ls && echo "éxito"       ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`éxito                    ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`éxito                    ` |
| ✅ | `ls archivo_que_no_existe `<br>`&& echo "no se ve"       ` | `ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       ` | `ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       ` |
| ✅ | `ls \|\| echo "no se ve"  ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    ` |
| ✅ | `ls archivo_que_no_existe `<br>`\|\| echo "se ve"        ` | `ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       `<br>`se ve                    ` | `ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       `<br>`se ve                    ` |
| ✅ | `true && echo "éxito" \|\|`<br>` echo "fallo"            ` | `éxito                    ` | `éxito                    ` |
| ✅ | `false && echo "no se ve" `<br>`\|\| echo "se ve"        ` | `se ve                    ` | `se ve                    ` |
| ✅ | `ls && ls && ls && ls && e`<br>`cho "todos exitosos"     ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`todos exitosos           ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`todos exitosos           ` |
| ✅ | `ls && ls archivo_que_no_e`<br>`xiste && ls && ls        ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       ` |
| ✅ | `ls \|\| ls \|\| ls \|\| l`<br>`s                        ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    ` |
| ✅ | `ls archivo_que_no_existe `<br>`\|\| echo "recuperación" `<br>`&& echo "continúa"       ` | `ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       `<br>`recuperación             `<br>`continúa                 ` | `ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       `<br>`recuperación             `<br>`continúa                 ` |
| ✅ | `(ls && echo "dentro de pa`<br>`réntesis") && echo "fuera`<br>` de paréntesis"          ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`dentro de paréntesis     `<br>`fuera de paréntesis      ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`dentro de paréntesis     `<br>`fuera de paréntesis      ` |
| ✅ | `(ls archivo_que_no_existe`<br>` \|\| echo "recuperado") `<br>`&& echo "continúa"       ` | `ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       `<br>`recuperado               `<br>`continúa                 ` | `ls: cannot access 'archiv`<br>`o_que_no_existe': No such`<br>` file or directory       `<br>`recuperado               `<br>`continúa                 ` |
| ✅ | `false \|\| (true && echo `<br>`"esto se ve")            ` | `esto se ve               ` | `esto se ve               ` |
| ✅ | `true && (false \|\| echo `<br>`"esto también")          ` | `esto también             ` | `esto también             ` |
| ✅ | `true && true \|\| false &`<br>`& false                  ` | `                         ` | `                         ` |
| ✅ | `false && false \|\| true `<br>`&& true                  ` | `                         ` | `                         ` |
| ✅ | `(ls && echo a) && (ls && `<br>`echo b) \|\| (ls && echo `<br>`c)                       ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`a                        `<br>`Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`b                        ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`a                        `<br>`Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    `<br>`b                        ` |

## 10_bonus_pipe_consec1 (PASS)
- Bash Exit: `0` | Minishell Exit: `0`

| Status | Command | Bash Output | Minishell Output |
| :---: | :--- | :--- | :--- |
| ✅ | `ls \|\| wc               ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    ` | `Bonus_tests.md           `<br>`interactive              `<br>`manual_tests             `<br>`minishell                `<br>`minishell.cast           `<br>`non_interactive          `<br>`results                  `<br>`run_tests.sh             `<br>`utils                    ` |

## 11_pipe_consec2 (PASS)
- Bash Exit: `2` | Minishell Exit: `0`

| Status | Command | Bash Output | Minishell Output |
| :---: | :--- | :--- | :--- |
| ✅ | `ls \|   \| wc            ` | `shell: syntax error near `<br>`unexpected token `\|'    `<br>`shell: `ls \|   \| wc'   ` | `shell: syntax error near `<br>`unexpected token `\|'    `<br>`shell: `ls \|   \| wc'   ` |

## 12_pipe_leading (PASS)
- Bash Exit: `2` | Minishell Exit: `0`
...
## 13_pipe_trailing_dif_behaviour (FAIL)
- Bash Exit: `0` | Minishell Exit: `0`

| Status | Command | Bash Output | Minishell Output |
| :---: | :--- | :--- | :--- |
| ✅ | `echo "It doesnt work as b`<br>`ash because BASH waits fo`<br>`r next line"             ` | `It doesnt work as bash be`<br>`cause BASH waits for next`<br>` line                    ` | `It doesnt work as bash be`<br>`cause BASH waits for next`<br>` line                    ` |
| ✅ | `echo "Our minishell print`<br>`s an error message and re`<br>`turns to prompt"         ` | `Our minishell prints an e`<br>`rror message and returns `<br>`to prompt                ` | `Our minishell prints an e`<br>`rror message and returns `<br>`to prompt                ` |
...
| Status | Test Description | Expected | Got |
| :---: | :--- | :---: | :---: |
| ✅ | SIGINT in child process | 130 | 130 |
| ✅ | SIGQUIT in child process | 131 | 131 |
| ✅ | SIGINT to minishell itself | 130 | 130 |
